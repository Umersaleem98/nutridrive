        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="templates/images/product_07_large.png" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            ...
            <p><a href="{{ url('cart') }}" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary">Add To Cart</a></p>
